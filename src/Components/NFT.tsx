    ...
    const handleMint = async () => {
        try {
            ...
            const request4 = {
                ...
                "BodyObj": {
                    "Body": `${imageCaption}\nThank you NFT minted using Deso has been sent!`,
                    "VideoURLs": [],
                            ...
                            <div className='border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none'>
                                ...
                                <div className='flex items-start justify-between p-5 border-b border-solid border-slate-200 rounded-t'>
                                    <h3 className='text-3xl font-semibold'>
                                        ...
                                        {loggedInUser && !isMinted && 'Thank you Message'}
                                        {isMinted && 'Minted!'}
                                    </h3>
                                    <button
                                ...
                                <div className='relative p-6 flex-auto'>
                                    ...
                                    <p className='overflow-clip'>
                                        ...
                                        {isMinted && 'Your NFT Thank You has been minted!'}
                                    </p>
                                    ...
                                    <div className='flex justify-center mt-7'>
                                        ...
                                        {isMinted && <a className='text-blue-500 underline '
                                            ...
                                            target="_blank">View Sent NFT message</a>}
